...
include Makefile.using_opam.coq.conf
...
Makefile.using_opam.coq.conf: _CoqProject_using_opam
	coq_makefile -f _CoqProject_using_opam -o Makefile.using_opam.coq

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include Makefile.using_opam.coq.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in Makefile.using_opam.coq.local once and for all.
...
# put in Makefile.using_opam.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in Makefile.using_opam.coq.local
#
###############################################################################
...
VDFILE := .Makefile.using_opam.coq.d
...
#
# There rules can be extended in Makefile.using_opam.coq.local
...
VDFILE_FLAGS:=$(if _CoqProject_using_opam,-f _CoqProject_using_opam,) $(CMDLINE_COQLIBS) $(CMDLINE_VFILES)

$(VDFILE): _CoqProject_using_opam $(VFILES)
	$(SHOW)'COQDEP VFILES'
...
# extension points and Makefile.using_opam.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefile.using_opam.coq.local or include Makefile.using_opam.coq.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in Makefile.using_opam.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create Makefile.using_opam.coq.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include Makefile.using_opam.coq.local-late
